...
router.route("/getListRadiologyByExcelSheet")
   .get(radiologyControl.generateExcelListRadiology, authorize(ROLES.ADMIN))
...
router.route("/:id")
   ...
   .put(protectedRoutes, authorize(ROLES.ADMIN), validation(updateRadiologyVal), radiologyControl.updateRadiology)



   // .delete(validation(paramsIdVal)  , radiologyControl.deleteTest)
   .delete(protectedRoutes, authorize(ROLES.ADMIN), validation(paramsIdVal), radiologyControl.deleteRadiology)

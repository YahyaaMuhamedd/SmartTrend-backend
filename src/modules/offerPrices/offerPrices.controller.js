...
export const getOffers = catchError(
   async(req , res , next)=>{
      ...
      //^ Filter If the result is not available in a company that has this analysis, do not include this company in the price offer :
      priceList = priceList.filter((ele)=>{
         return ele.testCount === testCount
      }) ;

...
router.route("/addAllTestPriceByExcelSheet")
   .post(protectedRoutes, authorize(ROLES.ADMIN, ROLES.USER), multerLocal(validExtension.excel, "excel").single("file"), priceControl.addTestPriceSheetExcelToDatabase)

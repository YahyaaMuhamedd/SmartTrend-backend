...
router.route("/deleted_all_tests_in_database")
      .delete(testControl.deletedAllTests, authorize(ROLES.ADMIN))
...
router.route("/:id")
      ...
      .put(protectedRoutes, authorize(ROLES.ADMIN), validation(updateTestVal), testControl.updateTest)



      // .delete(validation(paramsIdVal)  , testControl.deleteTest)
      .delete(protectedRoutes, authorize(ROLES.ADMIN), validation(paramsIdVal), testControl.deleteTest)

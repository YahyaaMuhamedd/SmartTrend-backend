...
router.route("/")
   ...
   .post(protectedRoutes, authorize(ROLES.ADMIN), validation(addBranchVal), BC.addBranch)
...
router.route("/:id")
   ...
   .put(protectedRoutes, authorize(ROLES.ADMIN), validation(updateBranchVal), BC.updateBranch)


   // .delete(validation(paramsIdVal), BC.deleteBranch)
   .delete(protectedRoutes, authorize(ROLES.ADMIN), validation(paramsIdVal), BC.deleteBranch)
